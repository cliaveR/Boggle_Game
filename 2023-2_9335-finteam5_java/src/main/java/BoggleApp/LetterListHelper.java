...
/**
* BoggleApp/LetterListHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from boggle.idl
* Thursday, May 16, 2024 3:05:57 PM SGT
*/

abstract public class LetterListHelper
{
  private static String  _id = "IDL:BoggleApp/LetterList:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (BoggleApp.LetterListHelper.id (), "LetterList", __typeCode);
    }
    return __typeCode;
  }
